...
jordi.enigma	enigma	C/Acàcies 38	Room escape juego: Entrar será muy fácil, os abrirán una puerta y accederéis a una habitación donde encontrareis diferentes objetos, todos con un sentido, no hay nada puesto por casualidad. Los elementos que no forman parte de los acertijos del juego estarán señalados para que no perdáis un precioso tiempo y os dediquéis a encajar todas las piezas. Salir no será tan fácil! Organizar vuestro equipo y enfretaos al enigma	5	27.00	60	jordi
jordi.enigmik	enigmik	C/Rosselló 508	Enigmik es un Room Escape en Barcelona. Está pensado para grupos de 2 a 6 personas. Tendréis 60 minutos para resolver todos los enigmas que se esconden dentro de una sala. El objetivo es simple: ¡No quedarse atrapado!	5	24.00	60	jordi
jordi.escapasipuedes	escapa si puedes	C/Grassot 97	Adéntrate en esta aventura en vivo y resuelve el misterioso caso del profesor Viruel.\r\nEntrar será fácil, lo difícil será salir. \r\nPon a prueba tu ingenio y habilidad para resolver los enigmas y retos que se te presenten y escapa si puedes.\r\nDispondrás de 60 minutos para salir. No todo el mundo lo consigue. ¿Podrás hacerlo tú?	5	28.00	60	jordi
jordi.escapebarcelona	escape barcelona	Pg.Valldaura 158	Sumérgete en una increible aventura en el nuevo juego de escape en Barcelona donde la aventura la vives tú junto a tus amigos.	6	21.00	60	jordi
